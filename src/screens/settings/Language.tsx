...
const language = (props:any) => {
  ...
  return (
    <View style={styles.sectionContainer}>
      ...
      <GenericText
      style={{margin:12,color:Screens.black}}
      >{SCREENS.LANGUAGESCREEN.SELECT_LANGUAGE}</GenericText>

      <Dropdown
          style={[styles.dropdown, isFocus && { borderColor: Screens.colors.background }]}
